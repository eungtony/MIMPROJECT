...
<html>
    <head>
        ...
        <link href="{{ asset('assets/libs/fontello/css/fontello.cs') }}s" rel="stylesheet" />
        ...
        <link href="{{ asset('assets/libs/rickshaw/rickshaw.min.cs') }}s" rel="stylesheet" type="text/css" />
